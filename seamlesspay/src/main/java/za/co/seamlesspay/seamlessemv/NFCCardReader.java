package za.co.seamlesspay.seamlessemv;
...
import za.co.seamlesspay.seamlessemv.parser.EmvParser;
import za.co.seamlesspay.seamlessemv.utils.AtrUtils;
...
public class NFCCardReader {
  ...
  public EmvCard readCardBlocking(Intent intent)
      throws IOException, WrongIntentException, WrongTagTech, UndeliverableException, ExceptionInInitializerError {
    final Tag tag = intent.getParcelableExtra(NfcAdapter.EXTRA_TAG);
    if (tag == null) {
