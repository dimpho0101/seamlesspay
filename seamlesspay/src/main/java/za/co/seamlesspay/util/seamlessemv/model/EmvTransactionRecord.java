 ...
 */
package za.co.seamlesspay.util.seamlessemv.model;

import java.io.Serializable;
import java.util.Date;

import za.co.seamlesspay.util.seamlessemv.model.enums.CountryCodeEnum;
import za.co.seamlesspay.util.seamlessemv.model.enums.CurrencyEnum;
import za.co.seamlesspay.util.seamlessemv.model.enums.TransactionTypeEnum;
import za.co.seamlesspay.util.seamlessemv.parser.apdu.annotation.Data;
import za.co.seamlesspay.util.seamlessemv.parser.apdu.impl.AbstractByteBean;
import za.co.seamlesspay.util.seamlessemv.parser.apdu.impl.DataFactory;
